                    ...
                    children: [
                      SwitchListTile(
                        ...
                        onChanged: (value) async {
                          await appSettings.setPrayerReminderEnabled(value);
                          if (value) {
                            // Fire-and-forget: if denied, reminders simply
                            // won't fire in the background; the in-app
                            // countdown on the Prayer Times screen still
                            // works either way.
                            unawaited(NotificationService.requestPermission());
                          } else {
                            unawaited(NotificationService.cancelAllScheduled());
                          }
                        },
                      ),
